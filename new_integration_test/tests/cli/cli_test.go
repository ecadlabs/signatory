...
func TestCliListOps(t *testing.T) {
	...
	require.Contains(t, string(out), "- double_consensus_operation_evidence")
	...
	require.Contains(t, string(out), "- preattestations_aggregate")
	...
	require.Contains(t, string(out), "- update_companion_key")
