...
// Package kwp implements AES Key Wrap with Padding (KWP) as defined in
// NIST SP 800-38F (https://csrc.nist.gov/publications/detail/sp/800-38f/final)
// and RFC 5649 (https://datatracker.ietf.org/doc/html/rfc5649).
//
// This implementation is inlined from Google's Tink cryptographic library:
//
//	Source: github.com/tink-crypto/tink (archived, formerly github.com/google/tink)
//	File:   go/kwp/subtle/kwp.go
//	Commit: d7460c2fb7583596fa564a23693516df4bd6de2e (master, 2024-04-02)
//	License: Apache License 2.0 (https://github.com/tink-crypto/tink/blob/master/LICENSE)
//
// The original Tink Go monorepo (github.com/google/tink) was archived on
// 2024-04-17. The successor repo (github.com/tink-crypto/tink-go/v2) does not
// expose this package in its public API. We inline it here to remove the
// dependency on the archived module.
//
// Modifications from the original:
//   - Package renamed from "subtle" to "kwp"
//   - Removed Google-internal "Placeholder for internal crypto/cipher allowlist" import comment
//
